...
select count(*) from [2023_Best_Books];

--Displays Duplicate Data--
select title, count(*) from [2023_Best_Books]
...
--Rename Column--
EXEC sp_rename '2023_Best_Books.title', 'Title', 'COLUMN';
EXEC sp_rename '2023_Best_Books.author', 'Author', 'COLUMN';
EXEC sp_rename '2023_Best_Books.star', 'Star', 'COLUMN';
EXEC sp_rename '2023_Best_Books.rating', 'Ratings', 'COLUMN';
EXEC sp_rename '2023_Best_Books.review', 'Reviews', 'COLUMN';
EXEC sp_rename '2023_Best_Books.pages', 'Pages', 'COLUMN';
EXEC sp_rename '2023_Best_Books.published', 'Published', 'COLUMN';
EXEC sp_rename '2023_Best_Books.year_published', 'Year_Published', 'COLUMN';
EXEC sp_rename '2023_Best_Books.genres', 'Genres', 'COLUMN';
...
SELECT FORMAT(CONVERT(DATE, Published), 'MMMM dd, yyyy') AS FormattedDate from [2023_Best_Books];
