...
url = 'https://www.goodreads.com/list/show/171064.Best_Books_of_2022?page={i}'
headers = {
...
def get_book_details(link):
    try:
        ...
        if book_info:
            ...
            published = book_info.find('p', {'data-testid': 'publicationInfo'}).text
            
            pages1 = pages.text.split()[0] if pages else None  # Asumsi halaman adalah angka pertama
             
            published2 = published[16:]
            year_published = published[-4:]
...
# Loop untuk halaman
for i in range(1, 17):  # Sesuaikan jumlah halaman yang diinginkan
    try:
...
csv_filename = 'best_books_2022_2.csv'
